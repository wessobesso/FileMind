...
struct OrangeCheckboxToggleStyle: ToggleStyle {
...
struct SettingsView: View {
    ...
    @State private var verboseLogsEnabled = false
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 2) {
                        HStack {
                            ...
                            .toggleStyle(OrangeCheckboxToggleStyle())
                            .accentColor(launchAtLogin ? .orange : .primary)
...
//                                }
                    ...
                    if advancedExpanded {
                        HStack(spacing: 16) {
                            Toggle(isOn: $verboseLogsEnabled) {
                                Text("Verbose logs")
                            }
                            .toggleStyle(OrangeCheckboxToggleStyle())
            ...
            // Toast overlay (single instance, always at bottom, on top of everything else)
            ZStack {
