                ...
                if isFindModeActive {
                    ...
                    TextField("Search, ask, or drop a file...", text: $viewModel.searchText)
                        ...
                        .onChange(of: viewModel.searchText) {
                            ...
                            // The disabling of isFindCommandActive when searchText is empty should be handled in the ViewModel
                            if viewModel.searchText.isEmpty {
                                isFindModeActive = false
                                // viewModel.isFindCommandActive = false // Remove this, handled in ViewModel
                            }
                            ...
                            // If /find mode is active and searchText is not empty, trigger performFindSearch
                            if viewModel.isFindCommandActive && !viewModel.searchText.isEmpty {
                                viewModel.performFindSearch()
                            }
                        }
                        .textFieldStyle(PlainTextFieldStyle())
